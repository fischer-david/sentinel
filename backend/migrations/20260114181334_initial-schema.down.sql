...
DROP TRIGGER IF EXISTS update_punishment_templates_updated_at ON punishment_templates;
...
DROP TRIGGER IF EXISTS update_punishment_notes_updated_at ON punishment_notes;

DROP FUNCTION IF EXISTS update_updated_at_column() CASCADE;

-- Drop indexes
DROP INDEX IF EXISTS idx_punishments_category_not_revoked;
DROP INDEX IF EXISTS idx_punishments_player_category_offense;
...
DROP INDEX IF EXISTS idx_punishment_messages_default;
DROP INDEX IF EXISTS idx_punishment_messages_active;
DROP INDEX IF EXISTS idx_punishment_messages_type;
DROP INDEX IF EXISTS idx_punishment_notes_staff_uuid;
...
DROP INDEX IF EXISTS idx_punishment_templates_active;
